non-sealed class Cylinder extends Shape {
    ...
    public void print() {
        ...
        System.out.println("Радиус основания цилиндра равен " + Math.sqrt(getVolume() / (height * Math.PI)));
        System.out.println("Площадь боковой поверхности цилиндра равна " + 2 * Math.sqrt(getVolume() * Math.PI * height));
